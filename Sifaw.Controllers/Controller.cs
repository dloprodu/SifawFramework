...
namespace Sifaw.Controllers
{
        ...
        where TOutput : Controller<TInput, TOutput>.Output
    {
        ...
        /// <summary>
        /// Devuelve todas las propiedades de la clase teniendo en cuenta las clases heredadas.
        /// </summary>
        protected List<PropertyInfo> GetAllProperty()
        {
            return UtilReflection.GetAllProperties(
                  this.GetType()
                , BindingFlags.Public
                | BindingFlags.NonPublic
                | BindingFlags.Static
        ...
        private List<IController> GetControllers(List<PropertyInfo> properties)
        {
        ...
        /// <summary>
        /// Resetea los campos de la controladora. Si son controladoras hijas las establece a un valor nulo. Para el resto de campos
        /// les establece el valor que indique su atributo <see cref="CLReseteable"/>. Los campos que no son controladoras ni campos
        /// marcados con el atributo <see cref="CLReseteable"/> son ignorados.
        /// </summary>
        /// <param name="fields">Lista de campos de la controladora.</param>
        /// <remarks>
