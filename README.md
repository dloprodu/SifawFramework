...
> *SF* aporta una solución a la hora de definir las controladoras y sus vistas y como estas interactuan entre si. El modelo y acceso a datos queda fuera de su ámbido pudiendo usar cualquier otro framework o como *EntityFramework*.
